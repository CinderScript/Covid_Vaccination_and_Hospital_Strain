...
census_meta <-listCensusMetadata(name = "dec/pl", vintage = 2020, type = "variables")
```


## Vaccination Rate of HRR
...
### Zip Code to Congressional District Crosswalk

This crosswalk is obtained from The U.S. Department of Housing and Urban Development's (HUD's) Office of Policy Development and Research (PD&R)

https://www.huduser.gov/portal/datasets/usps_crosswalk.html

### Zip Code to HRR Crosswalk

```{r}
  population <- getCensus(name = "dec/pl", vintage = 2020,
                          vars = c("P1_001N"), 
                          region = "tract:*",
