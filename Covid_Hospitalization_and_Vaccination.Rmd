...
```{r}
temp <- read_csv("cached-data/COVID-19_Reported_Patient_Impact_and_Hospital_Capacity_by_Facility.csv")

temp_date_filtered <- temp %>% 
  filter(collection_week == "2020-11-06")
